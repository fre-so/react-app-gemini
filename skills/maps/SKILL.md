...
- Only use components mentioned in this skill for interactive maps. Do not create new components or modify existing ones.

---

## MapRoute Component
Component Path: `components/maps/MapRoute.tsx`
